...
while running:
    ...
    if pull_left == True:
        pg.draw.line(screen, DARK_GREEN, (50, NEW_Y + GAMEBOARD_INSET), (NEW_X + GAMEBOARD_INSET_II, NEW_Y + GAMEBOARD_INSET), 25)
    if pull_right == True:
        pg.draw.line(screen, DARK_GREEN, (NEW_X + GAMEBOARD_INSET+15, NEW_Y + GAMEBOARD_INSET), (WIDTH-300, NEW_Y + GAMEBOARD_INSET), 25)
    if pull_up == True:
        pg.draw.line(screen, DARK_GREEN, (NEW_X + GAMEBOARD_INSET+20, 50), (NEW_X + GAMEBOARD_INSET+20, NEW_Y + GAMEBOARD_INSET), 25)
    if pull_down == True:
        pg.draw.line(screen, DARK_GREEN, (NEW_X + GAMEBOARD_INSET+20, NEW_Y + GAMEBOARD_INSET), (NEW_X + GAMEBOARD_INSET+20, HEIGHT-50), 25)
